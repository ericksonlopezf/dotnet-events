...
# Inbox (Idempotent Consumer Bridge)
dotnet-stryker -f stryker-config.inbox.json

# Outbox (Transactional Publisher Bridge)
dotnet-stryker -f stryker-config.outbox.json
