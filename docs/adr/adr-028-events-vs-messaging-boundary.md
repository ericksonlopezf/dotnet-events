# ADR-028: Boundary and Governance between Events.Contracts and Messaging.Abstractions
...
* **`dotnet-messaging` (`EricksonLopez.Messaging.Abstractions`)**: Defines generic message transport and routing abstractions for communicating across physical network boundaries and message brokers.
