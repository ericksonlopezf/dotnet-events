...
1. **Standardized Timestamps**: All event timestamps (`OccurredOn`, `PublishedAt`) MUST be serialized as UTC ISO 8601 strings (`yyyy-MM-ddTHH:mm:ss.fffffffZ`) via `DateTimeOffset`.
