...
public sealed class EventInboxServiceCollectionExtensionsTests
{
    ...
    [Fact]
    public async Task AddIdempotentEventHandler_RegistersAndResolvesDecoratedHandler()
    {
        ...
        services.AddIdempotentEventHandler<SampleOrderSubmitted, SampleOrderSubmittedHandler>("CustomOrderConsumer");
